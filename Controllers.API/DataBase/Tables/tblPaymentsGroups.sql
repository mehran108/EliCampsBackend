...
GO
IF (NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES  WHERE TABLE_NAME = 'tblPaymentsGroups')) 
BEGIN CREATE TABLE  [dbo].[tblPaymentsGroups](
...
CONSTRAINT [PK_tblPaymentsGroups] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [dbo].[tblPaymentsGroups]  WITH CHECK ADD  CONSTRAINT [FK_tblPaymentsGroups_tblRegistration] FOREIGN KEY([ClmPaymentsGrp_GroupID])
REFERENCES [dbo].[tblGroups] ([clmGroups_ID])


ALTER TABLE [dbo].[tblPaymentsGroups] CHECK CONSTRAINT [FK_tblPaymentsGroups_tblRegistration]
