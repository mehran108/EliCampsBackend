   ...
   public class InsuranceReportVM
    {
        ...
        public double CommissionAddins
        {
            get;
            set;
        }
        ...
        public List<int> ProgrameAddins
        {
            get;
            set;
        }

        public DateTime? ProgrameEndDate
        {
            get;
            set;
        }

        public DateTime? ProgrameStartDate
        {
            get;
            set;
        }
        ...
        public int? RoomSearchCampus
        {
            get;
            set;
        }

        public DateTime? RoomSearchFrom
        {
            get;
            set;
        }

        public DateTime? RoomSearchTo
        {
            get;
            set;
        }
        ...
        public List<int> StudentTrips
        {
            get;
            set;
        }

        public string StudentTripsID
        {
            get;
            set;
        }
